...
int MaxProfit(int* prices, int pricesSize){
    ...
    // 1) if the answer is Yes, the situation will become: [7, 1, 5, 3, 6, 4] <-> [7, 1, 5, 3, 6]
    ...
    // 2)if the answer is No, the situation will become:                             b  s
...
int main(void) {    
    ...
    printf("The most profit earned in this week is $%d!\n", profit);
